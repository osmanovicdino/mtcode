...
//    TetrahedralWithBivalent c2(params, Ns+NM2 , Ns + NM,orient,orient2); //set the difference to be  greater
    ...
    double forward_rate = 0.000001;
    double backward_rate = 0.00001;

    A.run_with_real_surface_remove_add_particles_continue(10000000, 10000, posfiles.size(), B, prod, forward_rate, backward_rate,c1, olddat,oldori,oldind,stringbase);
