...
//We explicitly pass the random number to these functions, as that leads to much better parallelization

//index1 and index2 are within critical distance and can bind or not
virtual void doublet(bool before, int index1, int index2, bool &after, double &ran) = 0;

virtual double calculate_score(int index1, int index2, bool b) = 0;

virtual void triplet(bool b12, bool b23, bool b13, bool c12, bool c23, bool c13, int index1, int index2, int index3, bool &after1, bool &after2, bool &after3, double &ran) = 0;
...
void doublet_eq(bool before, int index1, int index2, bool &after, double energ, double &ran);

void triplet_eq(bool b12, bool b23, bool b13, bool c12, bool c23, bool c13, int index1, int index2, int index3, bool &after1, bool &after2, bool &after3, double e12, double e23, double e13, double &ran);
