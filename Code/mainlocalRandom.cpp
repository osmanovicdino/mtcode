...
int main(int argc, char **argv)
{
    ...
    double x2 = gaussian_rand();
    double y2 = gaussian_rand();
    double z2 = gaussian_rand();

    double x3 = gaussian_rand();
    double y3 = gaussian_rand();
    double z3 = gaussian_rand();

    double x4 = gaussian_rand();
    double y4 = gaussian_rand();
    double z4 = gaussian_rand();

    double norm1 =  sqrt(SQR(x1)+SQR(y1)+SQR(z1));
    double norm2 =  sqrt(SQR(x2)+SQR(y2)+SQR(z2));
    double norm3 =  sqrt(SQR(x3)+SQR(y3)+SQR(z3));
    double norm4 =  sqrt(SQR(x4)+SQR(y4)+SQR(z4));
    ...
    ofstream myfile_invader;

    myfile_invader.open("invader_orient.csv");
    myfile_invader << x1 << "," << y1 << "," << z1 << endl;
    myfile_invader << x2 << "," << y2 << "," << z2 << endl;
    myfile_invader << x3 << "," << y3 << "," << z3 << endl;
    myfile_invader << x4 << "," << y4 << "," << z4 << endl;
