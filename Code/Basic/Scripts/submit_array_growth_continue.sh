...
cp ~/Chemistry/Code/mainNanostarImport.cpp /u/scratch/d/dinoo/${basedir}/${dirwemake}
g++ -fopenmp ~/Chemistry/Code/mainNanostarImport.cpp -o /u/scratch/d/dinoo/${basedir}/${dirwemake}/angron
