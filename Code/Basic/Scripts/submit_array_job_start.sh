...
filename=~/Chemistry/Code/Basic/Scripts/parameter_settings5.dat
if [ -e ${filename}   ]; then
...
basedir="SelfAssembly5"
dirwemake="try=${SGE_TASK_ID}"
mkdir /u/scratch/d/dinoo/${basedir}/${dirwemake}
cp ~/Chemistry/Code/mainNanotubeElasticShell2.cpp /u/scratch/d/dinoo/${basedir}/${dirwemake}
...
g++ -fopenmp -std=c++17 ~/Chemistry/Code/mainNanotubeElasticShell2.cpp -o /u/scratch/d/dinoo/${basedir}/${dirwemake}/angron
