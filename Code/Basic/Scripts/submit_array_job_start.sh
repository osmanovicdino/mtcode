...
filename=~/Chemistry/Code/Basic/Scripts/parameter_settings16.dat
if [ -e ${filename}   ]; then
...
basedir="SelfAssembly28"
dirwemake="try=${SGE_TASK_ID}"
mkdir /u/scratch/d/dinoo/${basedir}/${dirwemake}
cp ~/Chemistry/Code/mainNanotubeElasticShell5.cpp /u/scratch/d/dinoo/${basedir}/${dirwemake}
...
g++ -fopenmp -std=c++17 ~/Chemistry/Code/mainNanotubeElasticShell5.cpp -o /u/scratch/d/dinoo/${basedir}/${dirwemake}/angron
